...
//Plays a custom game and records the results. Specify the strategy for each player and the # of iterations.
  Move currmove;
...
//Plays the specified number of games with all players using the same specified strategy.  
  Move currmove;
  int count = 0;
  output.open(outputfilename);
  possmoves.open(possmovesfilename); 
